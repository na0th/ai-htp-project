...
TREE_LOCATION_RIGHT = BaseResult(3,
                                 ...
                                 [1, 1, 0, 0, 0])
TREE_STEM_BIG = BaseResult(4,
                           "현저하게 큰 줄기",
                           "- 상당히 큰 나무줄기를 그린 당신은 환경에 대하여 적극적으로 움직입니다. 현실과 공상 속에서 공격적으로 행동하려는 경향을 나타냅니다.",
                           [1, 1, 0, 0, 0])
TREE_STEM_SMALL = BaseResult(5,
                             "작은 나무줄기", 
                             "- 상당히 작은 나무줄기는 현실에 대한 무력감, 부적응감을 갖고 있음을 나타냅니다.",
                             [0, 0, 1, 1, 1])
TREE_STEM_THICK = BaseResult(6,
                             "굵은 기둥의 나무",
                             "- 기둥은 현재 당신의 상황을 나타냅니다. 너무 굵은 기둥은 여리고 소극적인 마음을 숨기고 자신을 크게 보이고 싶은 마음의 표현입니다.",
                             [1, 1, 0, 0, 0])
TREE_STEM_SLIM = BaseResult(7,
                            "매우 좁은 줄기",
                            "- 매우 좁은 줄기는 불확실한 적응과 생활에 부적합하게 얽매여 있을 수 있습니다. 만일 한 개의 선으로 그려진 줄기라면 얇은 선으로 표현된 기둥이나 가지는 예민한 성향을 나타냅니다. 주변 환경에 대해 어려움을 느끼고 회피 성향이 강한 편입니다. 또한 결단력이 없고 무력함을 느끼며 부적절한 만족감을 추구하고 있음으로 해석할 수 있습니다.",
                            [0, 0, 1, 0, 1])

TREE_SIZE_RESULT = [TREE_SIZE_SMALL, TREE_LOCATION_LEFT, TREE_LOCATION_MIDDLE, TREE_LOCATION_RIGHT, TREE_STEM_BIG, TREE_STEM_SMALL, TREE_STEM_THICK, TREE_STEM_SLIM]
